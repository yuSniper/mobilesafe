...
public class SplashActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 判断是否需要自动更新
		boolean autoUpdate = mPref.getBoolean("auto_update", true);// 默认为true
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					URL url = new URL(
							"http://192.168.47.23:8080/mytest/update.json");
	...
	public void copyDB(String dbName) {
		...
		System.out.println("目的数据库：" + destFile);
		if (destFile.exists()) {
	...
	public void createShortcut() {
		...
		shortcut_intent.setAction("com.example.mobilesafe.shortcut");
